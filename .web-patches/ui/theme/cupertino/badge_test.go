...
func TestBadgePainter_resolveColors_NilTheme(t *testing.T) {
	...
	if colors.Background != cupDefaultBadgeColors.Background {
...
func TestBadgePainter_resolveColors_WithTheme(t *testing.T) {
	...
	if colors.Background != theme.Colors.SystemRed {
		t.Error("badge background should be theme SystemRed color")
	}
}
...
type cupBadgeMockCanvas struct {
	drawCount          int
	drawCircleCount    int
...
func (c *cupBadgeMockCanvas) Clear(_ widget.Color)                                  {}
func (c *cupBadgeMockCanvas) DrawRect(_ geometry.Rect, _ widget.Color)              { c.drawCount++ }
func (c *cupBadgeMockCanvas) FillRectDirect(_ geometry.Rect, _ widget.Color)        {}
func (c *cupBadgeMockCanvas) StrokeRect(_ geometry.Rect, _ widget.Color, _ float32) { c.drawCount++ }
func (c *cupBadgeMockCanvas) DrawRoundRect(_ geometry.Rect, _ widget.Color, _ float32) {
	c.drawCount++
	c.drawRoundRectCount++
}
func (c *cupBadgeMockCanvas) StrokeRoundRect(_ geometry.Rect, _ widget.Color, _ float32, _ float32) {
	c.drawCount++
}
func (c *cupBadgeMockCanvas) DrawCircle(_ geometry.Point, _ float32, _ widget.Color) {
	c.drawCount++
	c.drawCircleCount++
}
func (c *cupBadgeMockCanvas) StrokeCircle(_ geometry.Point, _ float32, _ widget.Color, _ float32) {
	c.drawCount++
}
func (c *cupBadgeMockCanvas) StrokeArc(_ geometry.Point, _ float32, _, _ float64, _ widget.Color, _ float32) {
}
func (c *cupBadgeMockCanvas) DrawLine(_, _ geometry.Point, _ widget.Color, _ float32) {
	c.drawCount++
}
func (c *cupBadgeMockCanvas) DrawText(_ string, _ geometry.Rect, _ float32, _ widget.Color, _ bool, _ widget.TextAlign) {
	c.drawCount++
	c.drawTextCount++
}
func (c *cupBadgeMockCanvas) MeasureText(text string, fontSize float32, _ bool) float32 {
	return float32(len([]rune(text))) * fontSize * 0.5
}
func (c *cupBadgeMockCanvas) DrawImage(_ image.Image, _ geometry.Point)    { c.drawCount++ }
func (c *cupBadgeMockCanvas) PushClip(_ geometry.Rect)                     {}
func (c *cupBadgeMockCanvas) PushClipRoundRect(_ geometry.Rect, _ float32) {}
func (c *cupBadgeMockCanvas) PopClip()                                     {}
func (c *cupBadgeMockCanvas) PushTransform(_ geometry.Point)               {}
func (c *cupBadgeMockCanvas) PopTransform()                                {}
